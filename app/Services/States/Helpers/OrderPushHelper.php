...
class OrderPushHelper
{
    public static function updateRecord ($relation, $params, $operate = true)
    {
        try {
            ...
            return OrderPushRecords::where($orderPushWhere)->update($orderPushData);
        } catch ( \Exception $e ) {
    ...
    public static function getThirdResult ($orderId)
    {
        ...
        $result = CapitalClient::orderPushResult($orderData);
